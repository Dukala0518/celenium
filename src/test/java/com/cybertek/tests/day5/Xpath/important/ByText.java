...
public class ByText {
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//input[@name='pf.username']")).sendKeys("Dukala");
        driver.findElement(By.id("password")).sendKeys("Janjan");
      driver.findElement(By.id("signOnButton")).click();
      //  driver.close();
        driver.findElement(By.xpath("//A[.='Forgot Username?']")).click();
        //driver.close();
    }
}
