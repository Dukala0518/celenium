...
public class ByDinamicId {
    public static void main(String[] args) {
        //Formula is by xpath --   //tagName[@starts-with(@id,'someName')]
        //           by css   --     tagName[id^='someName']

                  //or ends with
        //Formula is by xpath --   //tagName[@ends-with(@id,'someName')]
        //           by css   --     tagName[id$='someName']
                    //contains//Formula is by xpath --   //tagName[@ends-with(@id,'someName')]
        //        //           by css   --     tagName[id$='someName']
        //Formula is by xpath --   //tagName[contains(@id,'someName')]
        //           by css   --     tagName[id*='someName']
        ...
        driver.findElement(By.cssSelector("input[id^='user']")).sendKeys("Dukala");
      //  driver.findElement(By.cssSelector("input[id$='word']")).sendKeys("Janjan");
        driver.findElement(By.cssSelector("input[id*='word']")).sendKeys("Janjan");
    }
