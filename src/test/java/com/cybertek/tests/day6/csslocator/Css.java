...
public class Css {
    //css is much easier when it comes to formula
    //id-r haihdaa #idNamwe---- #means id in css
    //formula can be---     #idName     or --        tagName#idName
    //                       .idName    or --         tagName.idName
    public static void main(String[] args) throws Exception {
        ...
        driver.findElement(By.cssSelector("#username")).sendKeys("Dukala");
        driver.findElement(By.cssSelector("input#password")).sendKeys("Janjan");
        //driver.findElement(By.cssSelector(".ping-button normal allow")).click();
        //driver.findElement(By.xpath("//a[.='Login']")).click();
        //driver.findElement(By.id("signOnButton")).click();
       WebElement welcomeWord= driver.findElement(By.cssSelector("html>body>div>div>h1"));
        System.out.println(welcomeWord.getText());
